...
const ScheduleEdit: React.FC<ScheduleEditProps> = ({ schedule, onClose }) => {
  ...
  const handleSave = async () => {
    ...
    const payload = {
      ...
      allDay,
      colorCode,
      timeOfStartDate: allDay ? undefined : format(startDate, "HH:mm"),
      timeOfEndDate: allDay ? undefined : format(endDate, "HH:mm"),
    };
  ...
  function handleColorClick(code: string): void {
