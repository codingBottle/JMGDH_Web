...
export default function CalenderNavbar({ onButtonClick, onToDay }:CalenderNavbarProps) {
  ...
  return (
    <CalenderNavbarCss>
      ...
      <button className="todaybtn" onClick={() => onToDay(new Date())}>TODAY</button>
        ...
        <button className="arrowbtn"><svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
